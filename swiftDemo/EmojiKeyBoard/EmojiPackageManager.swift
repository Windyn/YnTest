...
class EmojiPackageManager {
	/// bundle路径
	static let bundlePath = Bundle.main.path(forResource: "EmojiKeyBoard", ofType: "bundle")!
	/// emojiPackage路径
	static let emojiPackagePath = (EmojiPackageManager.bundlePath as NSString).appendingPathComponent("emojiPackage.plist")
	...
	class func loadEmojisAtPackageName(_ packageName: String) -> [EmojiModel] {
	...
	///
	/// - returns: 表情对象
	class func verificationEmojiWithString(_ string: String) -> EmojiModel? {
